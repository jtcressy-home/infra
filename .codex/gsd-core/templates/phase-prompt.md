...
<!-- For checkpoint task examples and patterns, see @.codex/gsd-core/references/checkpoints.md -->
...
See `.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `.codex/gsd-core/workflows/verify-phase.md` for verification logic.
