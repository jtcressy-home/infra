...
<required_reading>
@.codex/gsd-core/references/user-story-template.md
@.codex/gsd-core/references/spidr-splitting.md
@.codex/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@.codex/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@.codex/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@.codex/gsd-core/references/spidr-splitting.md`. Briefly:
