...
See .codex/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .codex/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using .codex/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .codex/gsd-core/templates/discovery.md
...
Use .codex/gsd-core/templates/discovery.md.
