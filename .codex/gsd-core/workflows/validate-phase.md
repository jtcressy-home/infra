...
```
Agent(
  prompt="Read /Users/jtcressy/workspace/infra/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jtcressy/workspace/infra/.codex/gsd-core/templates/VALIDATION.md`
