...
- **Global scope**: `/Users/jtcressy/workspace/infra/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jtcressy/workspace/infra/.codex/notes/`)
...
2. Glob `/Users/jtcressy/workspace/infra/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jtcressy/workspace/infra/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jtcressy/workspace/infra/.codex/notes/` — works in any directory
