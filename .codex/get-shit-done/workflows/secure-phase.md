...
```
Agent(
  prompt="Read /Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/get-shit-done/templates/SECURITY.md`
