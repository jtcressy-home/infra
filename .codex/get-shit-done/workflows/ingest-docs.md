...
```bash
INIT=$(node "/Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
