...
```bash
INIT=$(node "/Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/get-shit-done/templates/spec.md.
