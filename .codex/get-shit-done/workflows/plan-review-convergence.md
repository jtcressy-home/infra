...
```bash
INIT=$(node "/Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/Users/jtcressy/.codex/worktrees/bfc5/infra/.codex/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
