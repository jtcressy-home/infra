...
<required_reading>
@.codex/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@.codex/gsd-core/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = .codex/gsd-core
                  → writes to .codex/gsd-core/hooks/
...
@.codex/gsd-core/references/thinking-models-debug.md
...
- Read @.codex/gsd-core/references/common-bug-patterns.md
