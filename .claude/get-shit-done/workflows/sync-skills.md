...
INSTALL_JS_GLOBAL="/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
