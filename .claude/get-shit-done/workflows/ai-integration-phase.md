...
```markdown
Read /Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/agents/gsd-eval-planner.md for instructions.
