...
```
Agent(
  prompt="Read /Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/get-shit-done/templates/SECURITY.md`
