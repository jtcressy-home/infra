...
- **Global scope**: `/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/notes/`)
...
2. Glob `/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/notes/` — works in any directory
