...
<required_reading>
Read `/Users/jtcressy/.codex/worktrees/bfc5/infra/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
